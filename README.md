...
GPL-3:  Permission is granted to copy/modify, provided the source (N.
Matloff) is stated.  No warranties.
...
confidence interval for the difference et.c)
